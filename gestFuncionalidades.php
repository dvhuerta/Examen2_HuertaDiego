        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div class="card-body">
                ...
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Gestion de Funcionalidad</h6>
                </div>
                <div class="table-responsive">
                    ...
                    <table border="0">
                            ...
                            <tr>
                                <td><label id="lblNombre" for="modulo">Rol: </label></td>
                                <td><select name="modulo" id="modulo">
                                    <option value="persona">ADMINISTRATIVO</option>
                                    <option value="edificio">ESTUDIANTE</option>
                                    <option value="edificio">DOCENTE</option>
                                    </select></td>
                            </tr>

                            <tr>
                                <td colspan=2><input type="submit" name="accion" value="aceptar"></td>
                            </tr>
                        </table>
                        <!-- BOTÓN ELIMINAR -->
                        <table border=0>
